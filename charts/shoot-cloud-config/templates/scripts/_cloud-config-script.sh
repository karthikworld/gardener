...
binary-preload "kubelet" "https://storage.googleapis.com/kubernetes-release/release/{{ .Capabilities.KubeVersion.GitVersion }}/bin/linux/amd64/kubelet"
binary-preload "kubectl" "https://storage.googleapis.com/kubernetes-release/release/{{ .Capabilities.KubeVersion.GitVersion }}/bin/linux/amd64/kubectl"
